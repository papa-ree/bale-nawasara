...
use Paparee\BaleNawasara\App\Notifications\UptimeCheckFailed;
use Paparee\BaleNawasara\App\Notifications\UptimeCheckRecovered;
...
return [
    ...
    'notifications' => [
        ...
        'notifications' => [
            UptimeCheckFailed::class => ['slack'],
            UptimeCheckRecovered::class => ['slack'],
         ...
         */
        'resend_uptime_check_failed_notification_every_minutes' => 360,
