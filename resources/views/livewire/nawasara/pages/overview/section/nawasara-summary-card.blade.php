                        ...
                        <div class="flex items-start justify-between">
                            <div class="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    class="text-blue-500 lucide lucide-globe dark:text-blue-400">
                        ...
                        <table class="w-full text-sm text-left">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3">SSL Expiration</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        portal.balenawasara.com</td>
                                    <td class="px-4 py-3">2 min ago</td>
                                    <td class="px-4 py-3"><span
                                            class="px-2 py-1 text-xs text-green-800 bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-400">Up</span>
                                    </td>
                                ...
                                <tr
                                    class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        api.balenawasara.com</td>
                                    <td class="px-4 py-3">3 min ago</td>
                                    <td class="px-4 py-3"><span
                                            class="px-2 py-1 text-xs text-green-800 bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-400">Up</span>
                                    </td>
                                    <td class="px-4 py-3">32 days</td>
                                </tr>
                                <tr
                                    class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        support.balenawasara.com</td>
                                    <td class="px-4 py-3">5 min ago</td>
                                    <td class="px-4 py-3"><span
                                            class="px-2 py-1 text-xs text-yellow-800 bg-yellow-100 rounded-full dark:bg-yellow-900/30 dark:text-yellow-400">Slow</span>
                                    </td>
                                    <td class="px-4 py-3">62 days</td>
                                </tr>
                                <tr
                                    class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        blog.balenawasara.com</td>
                                    <td class="px-4 py-3">10 min ago</td>
                                    <td class="px-4 py-3"><span
                                            class="px-2 py-1 text-xs text-red-800 bg-red-100 rounded-full dark:bg-red-900/30 dark:text-red-400">Down</span>
                                    </td>
                                    <td class="px-4 py-3">120 days</td>
                                </tr>
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-4 py-3 font-medium text-gray-900 dark:text-white">
                                        status.balenawasara.com</td>
                                    <td class="px-4 py-3">15 min ago</td>
                                    <td class="px-4 py-3"><span
                                            class="px-2 py-1 text-xs text-green-800 bg-green-100 rounded-full dark:bg-green-900/30 dark:text-green-400">Up</span>
                                    </td>
                                    <td class="px-4 py-3">90 days</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
